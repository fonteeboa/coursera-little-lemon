...
const Footer: FC<HTMLAttributes<HTMLElement>> = (props): JSX.Element => {
  return (
    <Container {...props}>
      <Content>
        ...
        <Column>
          ...
          <ul>
            ...
            <li> <a href="tel:+551199999999" target="_blank" rel="external">+55 31 99999-9999</a> </li>
      ...
      <Copyright>
        <span>Developed by <a href="https://github.com/fonteeboa" target="_blank" rel="external"> Fonteeboa </a></span>
